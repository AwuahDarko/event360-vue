    ...
    <section class="ticket_attendees">
      ...
      >
        <div class="card" id="ticket_attend">
          <div class="card-header"><span class="heading"> Tickets </span></div>
          <div class="card-body">
            <h6>
              <b>Do your attendees need to pay to register for an event?</b>
            </h6>
            <div class="form-check pl-4">
              <input class="form-check-input" type="radio" name="pay-option" />
              <label class="form-check-label"
                >No, the event is free for everybody</label
              >
            </div>
            <div class="form-check pl-4">
              <input
            ...
            <div class="col-md-8">
              <small
                >Please contact us if your country/currency is not listed</small
              >
            </div>
          </div>
          <div class="card-footer">
        ...
        <div class="card" id="ticket_cost">
          ...
          <div class="card-body">
            ...
            <div class="form-check left-align-text mt-2">
              ...
              Event360 registration is free for free tickets
            </div>
            ...
            <div class="form-check left-align-text mt-2">
              ...
              We will charge the Event360 registration fee directly from your
            ...
            <div class="form-check left-align-text mt-2">
              ...
              You will receive 50% of the ticket sales 2 weeks after the event
              ends.
            </div>
            <div class="form-check left-align-text mt-2">
              <h6>
              ...
              You will receive the remaining payment 1 month after the event
              ends.
