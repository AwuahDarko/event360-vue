      ...
      <div class="card">
        <div class="card-body register-card-body">
          ...
          <form @submit="login">
            <div class="input-group mb-3">
              <input
                type="email"
                class="form-control"
                v-bind:class="{'is-empty': emailError}"
                v-model="email"
                placeholder="Email"
              />
            ...
            <div class="input-group mb-3">
              <input
                type="password"
                class="form-control"
                v-bind:class="{'is-empty': passwordError}"
                v-model="password"
            ...
            <div class="row">
              <div class="col-8">
                <div class="icheck-primary">
                  <input
                    style="margin-top: 5px !important; margin-right: 5px"
                    type="checkbox"
                    id="agreeTerms"
                    @change="rememberMe"
                  />
                  <label for="agreeTerms">Keep me logged in</label>
                </div>
              </div>
              <!-- /.col -->
              <div class="col-4">
          ...
          <p>
            ...
            <router-link to="sign-up" class="text-center">Register</router-link>
          </p>
        </div>
        <!-- /.form-box -->
      </div>
