        ...
        <div class="card-body register-card-body">
          ...
          <div class="social-auth-links text-center">
            ...
            <div class="row my_row">
              ...
              <div class="col-md-4 col-sm-4 col-xm-6">
                <a href="https://event360-gh.com/auth/google">
              ...
              <div class="col-md-4 col-sm-4 col-xm-6">
                <a
                  href="https://event360-gh.com/auth/linkedin"
                  title="LinkedIn"
          ...
          <p>
            Already have an event360 account?
            <router-link to="login" class="text-center">Login in.</router-link>
          </p>
        </div>
        <!-- /.form-box -->
      </div>
        ...
        .then(res => {
          ...
          if (res.status === 201) {
            window.localStorage.setItem(
              ...
              "Sign up was successful, please login now"
            );
...
.card-primary:not(.card-outline) > .card-headers a {
  color: #fff;
}
.card-primary:not(.card-outline) > .card-headers {
